const CACHE_VERSION="box-or-bust-20260831-2134";
const CORE=["./","./index.html","./jeu.html","./landing.css?v=3","./landing-performance.css?v=1","./styles.css?v=68","./branding.css?v=1","./achievements.css?v=1","./inventaire.js?v=1","./achievements.js?v=4","./game.js?v=100","./assets/backgrounds/depot-conteneur.png","./assets/boxes/colis-perdu.png","./assets/icons/logo-box-or-bust.webp","./assets/icons/box-or-bust-64.png","./assets/icons/box-or-bust-512.png"];
