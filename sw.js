const CACHE_VERSION="box-or-bust-20260831-0050";
const CORE=["./","./index.html","./jeu.html","./landing.css?v=3","./landing-performance.css?v=1","./styles.css?v=67","./achievements.css?v=1","./catalog.js?v=6","./catalog-20260830.js?v=4","./achievements.js?v=4","./game.js?v=99","./assets/backgrounds/depot-conteneur.png","./assets/boxes/colis-perdu.png","./assets/icons/box-or-bust.svg"];
