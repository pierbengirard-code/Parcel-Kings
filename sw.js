const CACHE_VERSION="box-or-bust-20260905-comptes";
const CORE=["./","./index.html","./jeu.html","./landing.css?v=3","./landing-performance.css?v=1","./styles.css?v=71","./branding.css?v=1","./achievements.css?v=1","./inventaire.js?v=1","./achievements.js?v=4","./game.js?v=102","./cloud-save.js?v=3","./auth-client.js?v=2","./assets/backgrounds/depot-conteneur.png","./assets/boxes/colis-perdu.png","./assets/icons/logo-box-or-bust.webp","./assets/icons/box-or-bust-64.png","./assets/icons/box-or-bust-512.png"];
